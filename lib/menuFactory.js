...
module.exports.getMainCharacterMenu = (character) => {
    let embed = new MessageEmbed()
    ...
    row.addComponents(new MessageButton().setCustomId('mainMenuManageCharacterGearBtn').setLabel('Gear').setStyle('PRIMARY'))if (user.grants.admin) {
        let adminRow = new MessageActionRow()
            .addComponents(new MessageButton().setCustomId('mainMenuManageGrantsBtn').setLabel('Manage Grants').setStyle('DANGER'))
        components.push(adminRow)
    }
