...
module.exports.getMainMenu = (user) => {
    let embed = new MessageEmbed()
        .setTitle('Character and War Manager')
        .setDescription(`NWCompanyBot is a war and character management tool.`)
        .setColor("#DAA520")
    let components = []
    let row = new MessageActionRow()
    row.addComponents(new MessageButton().setCustomId('mainMenuCharacterMainBtn').setLabel('Manage Character').setStyle('PRIMARY'))
...
module.exports.getCharacterMainMenu = (user) => {
    let embed = new MessageEmbed()
        .setTitle('Character Managment')
        .setDescription(`Update and maintain your character stats.`)
        .setColor("#DAA520")
    let components = []
    let row = new MessageActionRow()
    row.addComponents(new MessageButton().setCustomId('mainMenuManageCharacterBtn').setLabel('General Info').setStyle('PRIMARY'))
    row.addComponents(new MessageButton().setCustomId('mainMenuManageCharacterGearBtn').setLabel('Gear').setStyle('PRIMARY'))
    row.addComponents(new MessageButton().setCustomId('mainMenuManageCharacterTradesBtn').setLabel('Trades').setStyle('PRIMARY'))
    components.push(row)
        let adminRow = new MessageActionRow()
...
module.exports.getCharacterTradesMainMenu = (user) => {
    let embed = new MessageEmbed()
        .setTitle('Trades Managment')
        .setDescription(`Update and maintain your trade skills.`)
        .setColor("#DAA520")
    let components = []
    let row = new MessageActionRow()
...
module.exports.getCharacterGearMenu = (character) => {
    ...
    let row1 = new MessageActionRow()
        ...
        .addComponents(new MessageButton().setCustomId('manageCharacterWeight').setLabel('Armor Type').setStyle('PRIMARY'))
        .addComponents(new MessageButton().setCustomId('manageCharacterDPS').setLabel('DPS Role').setStyle('PRIMARY'))
    let row2 = new MessageActionRow()
        .addComponents(new MessageButton().setCustomId('manageCharacterGoBack').setLabel('Go Back').setStyle('SECONDARY'))
    return { embeds: [embed], components: [row1, row2] }
}

module.exports.getCharacterGatheringMenu = (character) => {
    let embed = character.embed
    let row1 = new MessageActionRow()
        .addComponents(new MessageButton().setCustomId('manageCharacterMining').setLabel('Mining').setStyle('PRIMARY'))
        .addComponents(new MessageButton().setCustomId('manageCharacterSkinning').setLabel('Skinning').setStyle('PRIMARY'))
        .addComponents(new MessageButton().setCustomId('manageCharacterFishing').setLabel('Fishing').setStyle('PRIMARY'))
        .addComponents(new MessageButton().setCustomId('manageCharacterLogging').setLabel('Logging').setStyle('PRIMARY'))
        .addComponents(new MessageButton().setCustomId('manageCharacterHarvesting').setLabel('Harvesting').setStyle('PRIMARY'))
    let row2 = new MessageActionRow()
        .addComponents(new MessageButton().setCustomId('manageCharacterGoBack').setLabel('Go Back').setStyle('SECONDARY'))
    return { embeds: [embed], components: [row1, row2] }
}

module.exports.getCharacterRefiningMenu = (character) => {
    let embed = character.embed
    let row1 = new MessageActionRow()
        .addComponents(new MessageButton().setCustomId('manageCharacterSmelting').setLabel('Smelting').setStyle('PRIMARY'))
        .addComponents(new MessageButton().setCustomId('manageCharacterStoneCutting').setLabel('StoneCutting').setStyle('PRIMARY'))
        .addComponents(new MessageButton().setCustomId('manageCharacterLeatherWorking').setLabel('LeatherWorking').setStyle('PRIMARY'))
        .addComponents(new MessageButton().setCustomId('manageCharacterWeaving').setLabel('Weaving').setStyle('PRIMARY'))
        .addComponents(new MessageButton().setCustomId('manageCharacterWoodWorking').setLabel('WoodWorking').setStyle('PRIMARY'))
    let row2 = new MessageActionRow()
        .addComponents(new MessageButton().setCustomId('manageCharacterGoBack').setLabel('Go Back').setStyle('SECONDARY'))
    return { embeds: [embed], components: [row1, row2] }
}

module.exports.getCharacterCraftingMenu = (character) => {
    let embed = character.embed
    let row1 = new MessageActionRow()
