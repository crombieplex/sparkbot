...
module.exports.getMainMenu = (user) => {
    ...
    row.addComponents(new MessageButton().setCustomId('mainMenuManageCharacterGearBtn').setLabel('Manage Gear').setStyle('PRIMARY'))
...
module.exports.getCharacterearMenu = (character) => {
    let embed = character.embed
    let row1 = new MessageActionRow()
