...
module.exports.getMainMenu = (user) => {
    let embed = new MessageEmbed()
        .setTitle('War and Invasion Planner')
        .setDescription(`WarBot is a war and invasion management tool. Simply update your charachter information and view and sign up for any open wars. If you are a war planner for your company please open a support ticket to be given access.`)
        .setColor("#DAA520")
    let components = []
